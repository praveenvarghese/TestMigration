...
scenario("Copy widget from GL dialog page to GL dialog page.", () => {
	...
	getAppManager()
		...
		.should.eql([
			...
			{
				Name: "TableFilterDialog_v2 (1)",
				Slug: "TableFilterDialog_v2_1",
				NodeType: "Widget",
				Tooltip: "TableFilterDialog_v2 (1) [ Widget ]",
				WidgetState: "",
			},
			{
			...
			{
				Name: "TableFilterDialog_v2 (2)",
				Slug: "TableFilterDialog_v2_2",
				NodeType: "Widget",
				Tooltip: "TableFilterDialog_v2 (2) [ Widget ]",
				WidgetState: "",
			},
			{
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["TableFilterDialog_v2 (1)"] },
		]);
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["TableFilterDialog_v2 (2)"] },
		]);
