...
scenario("Copy widget from normal page to GL dialog page.", () => {
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["PepperData (1)"] },
		]);
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["PepperData (2)"] },
		]);
