...
scenario("Copy widget from normal page to GL Sidepanel page.", () => {
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["Table1 (1)"] },
		]);
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["Table1 (2)"] },
		]);
