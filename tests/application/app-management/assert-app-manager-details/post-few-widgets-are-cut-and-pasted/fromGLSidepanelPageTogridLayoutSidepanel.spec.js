...
scenario("Cut widget from GL Sidepanel page to GL Sidepanel page.", () => {
	...
	// Paste the copied widget to custom layout
	getAppManager()
		.getFlyoutMenu({
	...
	openPageConfigurator()
		...
		.should.include.something.like([
			...
			{ areaName: "Unassigned widgets", widgets: ["standardTable"] },
		]);
