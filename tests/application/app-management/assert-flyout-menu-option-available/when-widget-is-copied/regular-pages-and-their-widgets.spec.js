...
scenario(
	"When a widget is copied, checking for Flyout menu options available for Regular pages at root, child and inner-child levels. And for their respective widgets.",
	() => {
