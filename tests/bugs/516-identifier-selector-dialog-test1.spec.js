...
scenario("Test asserting actions on Identifier selector dialog.", () => {
	...
	// Open identifier selector dialog for "NodeSet.0 Index" Option.And click on Finish button without any modifications.
	findWidget("MapV3")
	...
	// Open identifier selector dialog for "NodeSet.1 Index" Option.And click on Cancel button without any modifications.
	// Assert option editors available for Map Widget
	findWidget("MapV3")
		.nodeSetsMapLeafletOptionEditor()
	...
	// Open identifier selector dialog for "NodeSet.0 Latitude" Option.And click on Finish button without any modifications.
	findWidget("MapV3")
		.nodeSetsMapLeafletOptionEditor()
	...
	// Open identifier selector dialog for "NodeSet.1 Latitude" Option. And click on Cancel button without any modifications.
	findWidget("MapV3")
		.nodeSetsMapLeafletOptionEditor()
		.getOptionEntry(1, "Latitude")
		.clickToGetIdentifierSelectionDialog()
		.clickOnCancel();

	// Open identifier selector dialog for "NodeSet.0 Longitude" Option. Change the selected identifier and click on Finish button.
	findWidget("MapV3")
		.nodeSetsMapLeafletOptionEditor()
		.getOptionEntry(0, "Longitude")
		.clickToGetIdentifierSelectionDialog()
		.selectIdentifier("TestData_IND_Longitude")
		.clickOnFinish();
		...
		.should.eql([
			{
				...
				nodeSetsInfo: [
					...
					},
					{
						Name: "Longitude",
						NewOptionType: true,
						Value: "TestData_IND_Longitude(IND)",
						ListEntryOrder: 2,
					},
					{
						Name: "Size",
