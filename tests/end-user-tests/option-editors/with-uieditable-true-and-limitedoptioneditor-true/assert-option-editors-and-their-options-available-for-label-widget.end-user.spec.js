...
scenario(
	"As an end user, with Application-Settings UI-Editable set to 1 and Limited-Option-Editor set to 1. On Label Widget Settings Option Editor, asserting different category tabs available and options available on each of these categories.",
	() => {
		...
		// For the Label Widget Settings Option Editor, assert the header text and No-Permission-Message.
		findWidget("Lab1")
			.openOptionDialog()
