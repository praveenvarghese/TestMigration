...
scenario(
	"On PageV2 Hidden WebUI page, click on 'Download Image - PNG' button and assert the file name being downloaded.",
	() => {
		loadPage("Main Project/Test Page/A Grid Page But Hidden");
