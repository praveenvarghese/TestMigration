...
scenario(
	"Pivot the data on Bubble Chart. Right-click on Bubble Chart elements and assert respective item actions are shown.",
	() => {
		...
		// Close Option editor
		findWidget("BubbleChart_1_1").closeOptionDialog();
		...
		*/
		...
		// Unfold the Secondary page actions and click on action that clears of store focus entries
		// And the action that updates Item actions data
		findWidget("bubble_chart_data")
			.getSecondaryPageActions()
			.clickHamburgerButton();
		findWidget("bubble_chart_data")
