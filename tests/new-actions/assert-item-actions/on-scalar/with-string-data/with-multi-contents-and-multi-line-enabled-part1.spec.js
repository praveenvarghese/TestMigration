...
scenario(
	...
	() => {
		...
		// Open Sidepanel tab and enable multi-line for all Scalar widgets
		findWidget("scalar_data")
			.getSidepanels()
			.openSidepanelTab("Widget Settings");
		findWidget("Scalar Widget Misc Settings").setValue("Enable_MultiLine", true);
		findWidget("scalar_data")
			.getSidepanels()
			.closeSidepanelTab();

		/*
		On a Multi-contents Scalar with String Data from a simple String-Parameter, Read-only String-Parameter, multi-dimensional String-Parameters
		...
		*/
		...
		// findWidget("String Data").pressKeys([SPECIAL_KEYS.tab, SPECIAL_KEYS.escape]);
		findWidget("String Data")
			.getScalarCell("Sp_MyText")
			.click(0, 0);
