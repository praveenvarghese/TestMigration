...
scenario("Right click on a table cell. Assert action on click on icon of item action.", () => {
	loadPage("Main Project/Item Actions/Table Data?table-v2=true");
	...
	// Right click on cell (0,0). Click on the 4th item action. This is an inactive item action.
	findWidget("Shipping Departure DateTime")
		.getCell(0, 0)
		.rightClick()
