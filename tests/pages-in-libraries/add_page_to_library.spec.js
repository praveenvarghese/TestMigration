...
scenario("Add a page to a library and check that it works as expected.", () => {
	...
	getAppManager()
		...
		.should.eql([
			...
			},
			{
				...
				Slug: "ml1::newly_created_page",
				NodeType: "Pagev2-grid",
				Tooltip: "Newly created page [ Page ]",
				NodeState: "Collapsed",
				Icon: "icon-grid6",
				IsNodeSelected: false,
				NodeHasHiddenIndication: false,
