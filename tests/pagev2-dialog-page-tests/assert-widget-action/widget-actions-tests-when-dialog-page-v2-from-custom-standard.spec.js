...
scenario(
	"Validate widget actions when dialog page v2 layout is changed from custom to standard",
	() => {
		loadPage("Main Project/dp v2 CustomLayout");

		openPageConfigurator().selectLayout("Layout 6");

		//Validate widget action details displayed
		findWidget("Flag_4_v2")
		...
		findWidget("Flag_4_v2").setValue(false);
