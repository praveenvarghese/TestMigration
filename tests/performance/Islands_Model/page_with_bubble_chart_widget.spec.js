...
scenario("Islands Test Model - Measuring Performance of a page with Bubble Chart widget.", () => {
	loadPage("Main Project/Item Actions/Charts/Bubble Chart Data");
	findWidget("bubble_chart_data");
	getCurrentPage().should.be.equal("Main Project/Item Actions/Charts/Bubble Chart Data");
