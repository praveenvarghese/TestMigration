...
scenario(
	"Islands Test Model - Measuring Performance of a page with multiple Bar Chart widgets.",
	() => {
		loadPage("Main Project/Item Actions/Charts/Bar Chart Data");
		findWidget("bar_chart_data");
		getCurrentPage().should.be.equal("Main Project/Item Actions/Charts/Bar Chart Data");
