...
scenario(
	"Islands Test Model - Measuring Performance of a page with multiple Line Chart widgets.",
	() => {
		loadPage("Main Project/Item Actions/Charts/Line Chart Data");
		findWidget("line_chart_data");
		getCurrentPage().should.be.equal("Main Project/Item Actions/Charts/Line Chart Data");
