...
scenario(
	"Islands Test Model - Measuring Performance of a page with multiple Pie Chart widget.",
	() => {
		loadPage("Main Project/Item Actions/Charts/Pie Chart Data");
		findWidget("pie_chart_data");
		getCurrentPage().should.be.equal("Main Project/Item Actions/Charts/Pie Chart Data");
