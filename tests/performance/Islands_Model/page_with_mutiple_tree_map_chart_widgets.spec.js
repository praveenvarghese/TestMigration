...
scenario(
	"Islands Test Model - Measuring Performance of a page with multiple Tree Map Chart widget.",
	() => {
		loadPage("Main Project/Item Actions/Charts/Tree Map Data");
		findWidget("tree_map_data");
		getCurrentPage().should.be.equal("Main Project/Item Actions/Charts/Tree Map Data");
