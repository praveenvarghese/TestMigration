...
scenario("Lineas IBP Model - Performance Measurement on 'Demand Review/Forecast' page.", () => {
	loadPage("Main Project/Demand Review/Forecast");
	findWidget("forecast_1");
	getCurrentPage().should.be.equal("Main Project/Demand Review/Forecast");
