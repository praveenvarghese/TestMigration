...
scenario("Lineas IBP Model - Performance Measurement on 'MBR/Productivity' page.", () => {
	loadPage("Main Project/MBR/Productivity");
	findWidget("productivity_1");
	getCurrentPage().should.be.equal("Main Project/MBR/Productivity");
