...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Scenario Comparison/Forecast' page.",
	() => {
		loadPage("Main Project/Scenario Comparison/Forecast");
		findWidget("forecast_2");
		getCurrentPage().should.be.equal("Main Project/Scenario Comparison/Forecast");
