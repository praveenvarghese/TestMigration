...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Scenario Comparison/Overview' page.",
	() => {
		loadPage("Main Project/Scenario Comparison/Overview");
		findWidget("resource_comparison");
		getCurrentPage().should.be.equal("Main Project/Scenario Comparison/Overview");
