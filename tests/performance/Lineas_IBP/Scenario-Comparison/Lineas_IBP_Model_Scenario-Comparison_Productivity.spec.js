...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Scenario Comparison/Productivity' page.",
	() => {
		loadPage("Main Project/Scenario Comparison/Productivity");
		findWidget("productivity_2");
		getCurrentPage().should.be.equal("Main Project/Scenario Comparison/Productivity");
