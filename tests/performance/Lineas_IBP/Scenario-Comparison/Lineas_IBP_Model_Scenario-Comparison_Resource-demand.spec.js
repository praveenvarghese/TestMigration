...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Scenario Comparison/Resource demand' page.",
	() => {
		loadPage("Main Project/Scenario Comparison/Resource demand");
		findWidget("resource_demand");
		getCurrentPage().should.be.equal("Main Project/Scenario Comparison/Resource demand");
