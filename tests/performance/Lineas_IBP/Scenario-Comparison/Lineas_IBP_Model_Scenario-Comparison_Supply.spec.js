...
scenario("Lineas IBP Model - Performance Measurement on 'Scenario Comparison/Supply' page.", () => {
	loadPage("Main Project/Scenario Comparison/Supply");
	findWidget("supply_1");
	getCurrentPage().should.be.equal("Main Project/Scenario Comparison/Supply");
