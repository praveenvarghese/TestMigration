...
scenario("Lineas IBP Model - Performance Measurement on 'slowgraph_1' page.", () => {
	loadPage("Main Project/SlowGraph");
	findWidget("slowgraph_1");
	getCurrentPage().should.be.equal("Main Project/SlowGraph");
