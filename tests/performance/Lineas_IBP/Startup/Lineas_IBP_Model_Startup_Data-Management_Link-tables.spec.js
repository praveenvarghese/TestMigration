...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Startup/Data Management/Link tables' page.",
	() => {
		loadPage("Main Project/Startup/Data Management/Link tables");
		findWidget("link_tables");
		getCurrentPage().should.be.equal("Main Project/Startup/Data Management/Link tables");
