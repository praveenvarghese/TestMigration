...
scenario(
	"Lineas IBP Model - Performance Measurement on 'Startup/Data Management/Master data' page.",
	() => {
		loadPage("Main Project/Startup/Data Management/Master data");
		findWidget("forecasting_parameters");
		getCurrentPage().should.be.equal("Main Project/Startup/Data Management/Master data");
