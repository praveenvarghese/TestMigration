...
scenario("MKG TestModel - A page with few Gantt-Chart Widgets - Performance Measuring", () => {
	loadPage("Main Project/All Widgets In It/Gantt Chart");
	findWidget("gantt_chart");
	getCurrentPage().should.be.equal("Main Project/All Widgets In It/Gantt Chart");
	loadPage("Main Project/All Widgets In It/Gantt Chart");
	findWidget("gantt_chart");
	getCurrentPage().should.be.equal("Main Project/All Widgets In It/Gantt Chart");
	loadPage("Main Project/All Widgets In It/Gantt Chart");
