...
scenario(
	"MKG TestModel - A Custom-Layout (PageV2) page with GanttChart, Bar-LineChart, BubbleChart and Table widgets - Performance Measuring",
	() => {
		loadPage("Main Project/PageV2/Custom Layout");
		findWidget("custom_layout");
		getCurrentPage().should.be.equal("Main Project/PageV2/Custom Layout");
		loadPage("Main Project/PageV2/Custom Layout");
		findWidget("custom_layout");
		getCurrentPage().should.be.equal("Main Project/PageV2/Custom Layout");
		loadPage("Main Project/PageV2/Custom Layout");
