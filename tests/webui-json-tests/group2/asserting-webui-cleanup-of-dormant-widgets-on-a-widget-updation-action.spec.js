...
scenario(
	"With dormant widgets details available on WebUI json file. On updating a widget, assert WebUI.json file cleanup is done.",
	() => {
		loadPage("Main Project/WebUI Json?_aimms_only_persistence.write=true");

		// Resize a widget
		openWidgetManager().setWidgetSize("Read WebUIjson", { width: 3 });
