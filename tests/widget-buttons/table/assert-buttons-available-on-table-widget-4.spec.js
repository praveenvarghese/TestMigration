...
scenario(
	"On table with Filters applied, asserting buttons available on header section, when on&off focus, on cell edit.",
	() => {
		loadPage("Main Project/Sorting/Sorted Table");

		// Move focus away from table widget. Hover another widget on the page.
		findWidget("Sorted_Table_1").movePointerToWidget(10, 5);
		...
		findWidget("Sorted_Table_2").movePointerToWidget(70, 20);
		findWidget("Sorted_Table_2")
			.getButtons()
			.should.eql([
				WIDGET_HEADER_BUTTONS.CHROME_BUTTON_FILTERS,
		...
		findWidget("Sorted_Table_2").movePointerToWidget(170, 200);
		findWidget("Sorted_Table_2")
			.getButtons()
			.should.eql([
				WIDGET_HEADER_BUTTONS.CHROME_BUTTON_FILTERS,
		...
		findWidget("Sorted_Table_2").movePointerToWidget(350, 350);
		findWidget("Sorted_Table_2")
			.getButtons()
			.should.eql([
				WIDGET_HEADER_BUTTONS.CHROME_BUTTON_FILTERS,
