...
scenario(
	"On table with refresh data and Filters applied, asserting buttons available on header section, when on&off focus, on cell edit.",
	() => {
		...
		// Click on another cell of the same table widget. And assert the buttons available.
		findWidget("Sorted_Table_2")
			.getCell(0, 1)
			.click();
		findWidget("Sorted_Table_2")
