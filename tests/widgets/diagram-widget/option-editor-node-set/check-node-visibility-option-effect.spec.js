...
scenario(
	"Check the effect of all three (literal) settings for the Button Visibility option",
	() => {
		...
		findWidget("MyDiagram")
			.openDiagramNodeSetOptionEditor()
			.expandNodeSet(0)
			.setButtonVisibility(0, "Inactive");
