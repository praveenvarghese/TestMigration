...
scenario("Check whether item actions work fine on a Column Chart", () => {
	...
	findWidget("IA1")
		.getNthBarForMultipleContents({ content: 10, bar: 4 })
		.rightClick(0, 0);
	...
	findWidget("IA1")
		.getNthBarForMultipleContents({ content: 11, bar: 3 })
		.rightClick(0, 0);
