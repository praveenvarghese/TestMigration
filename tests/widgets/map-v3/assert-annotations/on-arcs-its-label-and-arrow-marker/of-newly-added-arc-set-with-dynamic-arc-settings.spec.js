...
scenario(
	"On the Map, add a new Arc-Set. Arcs having webui::AnnotationsIdentifier annotations and Dynamic width arc settings. Assert annotations on the arc.",
	() => {
		...
		// For Arcs of 2nd Arc-set, update Arc settings to have Dynamic width.
