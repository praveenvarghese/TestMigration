...
scenario(
	"On the Map, add a new Arc-Set. Arcs having webui::AnnotationsIdentifier annotations and Straight-lines arc settings. Assert annotations on the arc.",
	() => {
		...
		// For Arcs of 2nd Arc-set, update Arc settings to have straight lines.
		findWidget("Arc Settings_1")
			.getCell(6, 0)
			.setValue(true);
