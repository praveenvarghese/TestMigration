...
scenario(
	"For Map loaded with Nodes and Arcs. Arcs with webui::AnnotationsIdentifier data and dynamic widths arc settings. Assert annotations associated with arcs.",
	() => {
		...
		// Updating the 2 arc-sets to have dynamic widths.
