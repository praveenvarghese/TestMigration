...
scenario(
	"For Map loaded with Nodes and Arcs. Arcs with webui::AnnotationsIdentifier data and hide-label arc settings. Assert annotations associated with arcs.",
	() => {
		...
		// Updating the 2 arc-sets to hide labels.
