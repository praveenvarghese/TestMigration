...
scenario(
	"For Map loaded with Nodes and Arcs. Arcs with webui::AnnotationsIdentifier annotations. With annotations being updated. Assert annotations on the arc.",
	() => {
		...
		// Updating annotations data of Arc-Set-1
		findWidget("Load Annotations of ArcsBetween_C_A").click();
		...
		arcSet1
			...
			.getAnnotations()
			.should.include.something.like({
				arcAnnotations: ["StartingFromAmsterdam", "Capital"],
				arcLabelAnnotations: ["StartingFromAmsterdam", "Capital"],
				arcMarkerAnnotations: ["StartingFromAmsterdam", "Capital"],
			});
		...
		arcSet1
			...
			.getAnnotations()
			.should.include.something.like({
				arcAnnotations: ["StartingFromAmersfoort"],
				arcLabelAnnotations: ["StartingFromAmersfoort"],
				arcMarkerAnnotations: ["StartingFromAmersfoort"],
			});
		...
		// Updating annotations data of Arc-Set-0
		findWidget("Update Annotations of ArcsBetween_A").click();
		...
		arcSet0
			...
			.getAnnotations()
			.should.include.something.like({
				arcAnnotations: ["FromRotterdamAirport", "ToTeugeAirport"],
				arcLabelAnnotations: ["FromRotterdamAirport", "ToTeugeAirport"],
				arcMarkerAnnotations: ["FromRotterdamAirport", "ToTeugeAirport"],
			});
		...
		arcSet0
			...
			.getAnnotations()
			.should.include.something.like({
				arcAnnotations: ["FromTeugeAirport", "ToLelystadAirport"],
				arcLabelAnnotations: ["FromTeugeAirport", "ToLelystadAirport"],
				arcMarkerAnnotations: ["FromTeugeAirport", "ToLelystadAirport"],
			});
		...
		// Reload the page, and assert annotations on the arcs
		pageRefresh();
