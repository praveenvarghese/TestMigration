...
scenario(
	"Validate the behaviour of the active tab option when tab is changed from Element Parameter",
	() => {
		loadPage("Main Project/ActiveTab");

		findWidget("ActiveTab").setValue("linechart_1");
		...
		findWidget("ActiveTab").setValue("scatterchart_1");
