...
scenario(
	"Table with domain, after slicing to second fixed element, should have correct data in cells.",
	() => {
  ...
  */
		...
		// a index is now sliced to fixed element, so removed from cube domain
