...
scenario(
	...
	() => {
		...
		findWidget("ExportTable").goInFullScreenMode();

		findWidget("ExportTable").isFullScreen().should.be.true;

		// Block-selection on table
		findWidget("ExportTable").setSelection(0, 0, 3, 4);
		...
		findWidget("ExportTable").exitFullScreenMode();
