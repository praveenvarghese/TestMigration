...
scenario("Copy from and to a table which has scrollbars on it", () => {
	...
	// Copy a rectangular block to the a cell which is at the bottom end of the visible part of the table
	findWidget("BigTable").setSelection(0, 0, 3, 6);
	findWidget("BigTable").pressCtrl(["c"]);
	findWidget("BigTable").pasteToCell(8, 0);

	findWidget("BigTable")
		.getSelectionValues(8, 0, 11, 6)
