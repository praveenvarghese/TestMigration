...
scenario("Validate upload Excel file to table with Identifier element text", () => {
	...
	findWidget("IDelemtextUCoT")
		.getValue()
		.should.equal("Unit Cost of Transportation");

	findWidget("IDelemtextUCoT").setValue("Unit Cost of Transport");
	...
	findWidget("UCofTransport")
		...
		.uploadExcelFile("UCofTransport_mod2.xlsx");

	findWidget("UCofTransport")
		.getCell(0, 0)
		.getValue()
		.should.be.equal("81.00");
});
