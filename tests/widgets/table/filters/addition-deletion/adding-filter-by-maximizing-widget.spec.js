...
scenario("Adding filter by maximising the widget", () => {
	loadPage("Main Project/home");

	findWidget("DailyPassengers").goInFullScreenMode();
	findWidget("DailyPassengers").isFullScreen().should.be.true;
	...
	findWidget("DailyPassengers").isFullScreen().should.be.false;
