...
scenario("Validating filter gets reset when one of content is added ", () => {
	...
	findWidget("PepperData")
		...
		.addItemFromAvailableContents("RipeColour");

	expected_values = [
		["50,000 Scoville", "red"],
		["5,000 Scoville", "red"],
		["50,000 Scoville", "yellow"],
		["8,000 Scoville", "red"],
		["2,500 Scoville", "red"],
		["115,500 Scoville", ""],
	];
	...
	findWidget("PepperData")
		.getContentsOptionEditor()
		.removeSpecificItemFromCurrentContents("RipeColour");
