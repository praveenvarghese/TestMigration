...
scenario("Validating filter gets reset when widget type is changed", () => {
	...
	findWidget("PepperData")
		...
		.changeWidgetTypeTo("scalar");

	findWidget("PepperData").should.be.a.widgetOfType("scalar");

	findWidget("PepperData")
		.getValue()
		.should.be.equal("115,500 Scoville");
