...
scenario("Removal of both column and row filter rule from table header", () => {
	loadPage("Main Project/TablePage?_aimms_only_data_filter=true&table-v2=true");
