...
scenario("Creation ,Editing and deletion of text widget from scratch in a Dialog Page", () => {
	// Model: MealRus
	loadPage("Main Project/Charts/bubbleChartDialogPage?_aimms_only_persistence.write=true");

	createWidget("text", "TextWidget");

	findWidget("bubblechartdialogpage_1")
		.getVisibleWidgets()
		.should.eql(["dialogPageBubbleChart", "TextWidget"]);
	...
	findWidget("bubblechartdialogpage_1").clickDialogPageButton("ok");

	openAppManager().navigateToPage("Main Project/Charts/bubbleChartDialogPage");
